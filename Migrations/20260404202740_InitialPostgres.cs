        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearOfCreate = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictionHomeScore = table.Column<int>(type: "integer", nullable: true),
                    PredictionAwayScore = table.Column<int>(type: "integer", nullable: true),
                    isCorrect = table.Column<bool>(type: "boolean", nullable: true),
                    Points = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PredictionWinner = table.Column<int>(type: "integer", nullable: true),
                    ActualWinner = table.Column<int>(type: "integer", nullable: true),
                    BonusPointsWinner = table.Column<int>(type: "integer", nullable: true),
                    PredictionBTTS = table.Column<bool>(type: "boolean", nullable: true),
                    IsCorrectBTTS = table.Column<bool>(type: "boolean", nullable: true),
                    PointsFromBTTS = table.Column<int>(type: "integer", nullable: true),
                    PredictionOULine = table.Column<int>(type: "integer", nullable: true),
                    PredictionOUPick = table.Column<int>(type: "integer", nullable: true),
                    ActualOUResult = table.Column<bool>(type: "boolean", nullable: true),
                    BonusPointsOU = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
