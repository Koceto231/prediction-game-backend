...
namespace BPFL.API.Shared.External
{
    public class SportmonksClient
    {
        ...
        public async Task<List<SmEvent>> GetFixtureEventsAsync(int fixtureId, CancellationToken ct = default)
        {
        ...
        public async Task<List<SmStatistic>> GetFixtureStatisticsAsync(int fixtureId, CancellationToken ct = default)
        {
            var root = await GetAsync<SmSingleRoot<SmFixtureWithIncludes>>(
        ...
        public async Task<List<SmSquadPlayer>> GetSquadByTeamIdAsync(int teamId, CancellationToken ct = default)
        {
    ...
    public class SmRoot<T> { public List<T> Data { get; set; } = []; }
    ...
    public class SmSingleRoot<T> { public T? Data { get; set; } }
    ...
    public class SmFixture
    {
        ...
        [JsonPropertyName("starting_at")] public string? StartingAt { get; set; }
        [JsonPropertyName("state_id")]   public int? StateId { get; set; }
        [JsonPropertyName("result_info")] public string? ResultInfo { get; set; }
        [JsonPropertyName("has_odds")]   public bool HasOdds { get; set; }
    ...
    public class SmEvent
    {
        ...
        [JsonPropertyName("related_player_id")]   public int? RelatedPlayerId { get; set; }
        [JsonPropertyName("related_player_name")] public string? RelatedPlayerName { get; set; }
        [JsonPropertyName("participant_id")] public int ParticipantId { get; set; }
    ...
    public class SmStatData { public int? Value { get; set; } }

    public class SmSquadPlayer
    {
        [JsonPropertyName("player_id")]  public int PlayerId { get; set; }
        [JsonPropertyName("position_id")] public int? PositionId { get; set; }
